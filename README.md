...
2. 2. Przejdź do SQL Editor
  
   3. 3. Skopiuj zawartość pliku supabase/schema.sql
     
      4. 4. Wklej i uruchom (kliknij "Run")
...
- - ✅ Tworzenie i edycja artykułów
  ...
  - - ✅ SEO meta tagi i FAQ (dla AI Overviews)
    ...
    - - Przeplyw.webp - grafika hero
      ...
      2. 2. Kliknij "Add New Project"
        
         3. 3. Zaimportuj repozytorium ordoflow z GitHub
    ...
    - 1. Dodaj ordoflow.pl
      ...
      2. 2. Skopiuj rekordy DNS
        
         3. 3. W panelu Cyberfolks zmień DNS na podane przez Vercel
